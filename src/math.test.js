...
describe('função fatorial', () => {
  ...
  // Corrigido "factorial" para "fatorial"
...
describe('função fibonacci', () => {
  test('valida entrada', () => {
    ...
    expect(() => fibonacci(8)).not.toThrow(TypeError); // Este deve ser mantido
...
describe('função ehPrimo', () => {
  test('valida entrada', () => {
    ...
    // Corrigido a mensagem de erro esperada
    expect(() => ehPrimo(1)).toThrow(Error);
    expect(() => ehPrimo(1)).toThrow("Não existe número primo para valores menores ou iguais a 1");
    expect(() => ehPrimo(0)).toThrow(Error);
    expect(() => ehPrimo(0)).toThrow("Não existe número primo para valores menores ou iguais a 1");
