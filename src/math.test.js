...
describe('função fatorial', () => {
  test('valida entrada', () => {
    ...
    expect(() => fatorial("10")).toThrow(TypeError); // Corrigido para lançar erro
    expect(() => fatorial(10)).not.toThrow(); // OK
...
describe('função fibonacci', () => {
  test('valida entrada', () => {
    ...
    expect(() => fibonacci("10")).toThrow(TypeError); // Corrigido para lançar erro
    expect(() => fibonacci(10)).not.toThrow(); // OK
...
describe('função ehPrimo', () => {
  test('valida entrada', () => {
    ...
    expect(() => ehPrimo("10")).toThrow(TypeError); // Corrigido para lançar erro
    expect(() => ehPrimo(10)).not.toThrow(); // OK
