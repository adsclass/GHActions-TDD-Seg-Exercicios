...
describe('função fibonacci', () => {
  test('valida entrada', () => {
    ...
    expect(() => fibonacci(-10)).toThrow("Não existe fibonnacci de número menor ou ingual a zero");
    expect(() => fibonacci(0)).toThrow(TypeError);
    expect(() => fibonacci(0)).toThrow("Não existe fibonnacci de número menor ou ingual a zero");
  });
